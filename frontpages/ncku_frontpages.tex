...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       考試合格證明 (Certificate of Approval)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% NCKU regulation: the signed certificate is bound as page 2, right after the cover.
% Full-page embed of the scanned PDF; no page number / watermark on this page.
\includepdf[pages=1,fitpaper=true,pagecommand={\thispagestyle{empty}}]{frontpages/approval.pdf}
