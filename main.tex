...
\usepackage{indentfirst} % 強制每節標題後的第一段也縮排
...
%%\fi
      \usepackage[pdftex]{graphicx}
      \newcommand\myworkflow{pdftex}  % set the flag
\usepackage{pdfpages}  % embed the signed Certificate of Approval as page 2 (must load after graphicx)
...
%% 中文數字章別 >>> (英文版關閉：章別以「Chapter 1」呈現)
%\renewcommand\countermapping[1]{\CJKnumber{#1}}
%\renewcommand\tocprechaptername{第}
%\renewcommand\tocpostchaptername{章}
%\setlength{\tocChNumberWidth}{2.5em}
%\makeatletter
%\def\@makechapterhead#1{%
%  {\parindent \z@ \centering \normalfont
%    \ifnum \c@secnumdepth >\m@ne
%        \LARGE\bfseries \prechaptername\countermapping{\thechapter}\postchaptername
%    \fi
%    \hspace{1em}
%    \interlinepenalty\@M
